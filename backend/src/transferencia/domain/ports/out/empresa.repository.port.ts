...
export interface EmpresaRepositoryPort {
  ...
  findEmpresasConTransferenciasUltimoMes(fechaInicio: Date, fechaFin: Date): Promise<Empresa[]>;
  findEmpresasAdheridasUltimoMes(fechaInicio: Date, fechaFin: Date): Promise<Empresa[]>;
}