...
import { HomeOutlined, MenuUnfoldOutlined, MenuFoldOutlined, UserOutlined, BookOutlined } from '@ant-design/icons';
...
const MainLayout = () => {
  ...
  const menuBase = [
    ...
    },
    {
      key: '/empresas',
      icon: < BookOutlined/>,
      label: <Link title='Home' to={'/empresas'}>Empresas</Link>
    },
    {
      key: '/users',
      icon: <UserOutlined />,
      label: <Link title='Users' to={'/users'}>Users</Link>
    },
  ]; 
